/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f7965c6f756d6ce57faba01c33c02b8)
// Runtime types generated with workerd@1.20260908.1 2026-09-09
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	APP_ORIGIN: "http://localhost:5173";
	BOOTSTRAP_ADMIN_EMAIL: "admin@blendproof.local";
	BOOTSTRAP_ADMIN_NAME: "本地管理员";
	UPLOAD_SIGNING_SECRET: string;
	SHARE_ACCESS_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "BOOTSTRAP_ADMIN_EMAIL" | "BOOTSTRAP_ADMIN_NAME" | "UPLOAD_SIGNING_SECRET" | "SHARE_ACCESS_SECRET" | "BOOTSTRAP_ADMIN_TOKEN">> {}
}
